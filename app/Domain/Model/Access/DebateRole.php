...
class Role extends Model
{
    ...
    protected $fillable = ['roleid', 'projectid', 'name', 'description', 'photo', 'groupsplayingrole', 'usersplayingrole', 'scopes', 'created_by'];

    public function __construct($roleid = null, $projectid = null,  $name = null, $description = null, $photo = null,
